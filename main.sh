...
REPO="https://raw.githubusercontent.com/pwtinject/apyh/main/"
...
restart_system(){
url_izin="https://raw.githubusercontent.com/pwtinject/koncol/main/ip"
...
# Ganti Banner
wget -O /etc/banner.com "${REPO}files/issue.net"
